...
class image_clustering:
	...
	def load_images(self):
		...
		for image in self.image_paths:
			...
			self.images.append(cv2.cvtColor(cv2.resize(a, (224,224)), cv2.COLOR_BGR2RGB))
	...
	def clustering(self):
		...
		for i in range(self.max_examples):
			shutil.copy2(self.folder_path+"/"+self.image_paths[i], "./clusterd"+str(predictions[i]))
